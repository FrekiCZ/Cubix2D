...
{
    private static final Map<Integer, Integer> field_74531_a = new HashMap<Integer, Integer>();
    private static final List<Integer> field_74530_b = new ArrayList<Integer>();
    ...
    {
        Iterator<Entry<Integer, Integer>> var0 = field_74531_a.entrySet().iterator();
